		...
		// 	}
			...
			if(empty($errors)){
				...
				if(mysql_affected_rows() == 1) {
					//Success
					$message = "The subject was succefully updated"; 
				} else  {
					//Failed
...
<?php require ("includes/header.php"); ?>
	...
	<div class="content">
		...
		<form action="edit_subject.php?subj=<?php echo urlencode($sel_subject['id']); ?>" method="post">
			...
			<p>
				<input class="submit_btn" type="submit" name="submit" value="Edit Subject" />
				&nbsp;&nbsp;
				<a href="delete_subject.php?subj=<?php echo urlencode($sel_subject['id']); ?>" onclick="return confirm('Are you sure you want to delete?')" > Delete Subject </a>
			</p>
		</form>
		...
		<?php  
			...
			while ($page = mysql_fetch_array($subject_pages)) {
				echo "<li><a href=\"content.php?pages={$page['id']}\">
				{$page['menu_name']}</a></li>";
			}
		?>
		<br/><br/>
